        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mb-1">
            <a 
              ...
              className="font-semibold text-gray-900 hover:text-pink-400 transition-colors duration-200 inline-flex items-center gap-1"
            >
              <span>{result.title}</span>
              <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 flex-shrink-0 inline text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
