      ...
      {!mamTokenExists ? (
        ...
        <>
          <form onSubmit={doSearch} className="mt-5 flex flex-col sm:flex-row gap-2 relative">
            ...
            <button className="rounded-md bg-pink-400 px-5 py-2.5 text-sm font-semibold text-white hover:bg-pink-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-500 cursor-pointer min-w-[100px] flex items-center justify-center" disabled={loading || !q.trim()}>
              {loading ? (
                // loading spinner
